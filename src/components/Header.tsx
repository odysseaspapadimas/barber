    ...
    <>
      <header className="p-4 flex items-center bg-sidebar text-sidebar-foreground shadow-lg">
        <button
          ...
          className="p-2 hover:bg-sidebar-ring rounded-lg transition-colors"
      ...
      >
        ...
        <nav className="flex-1 p-4 overflow-y-auto">
          <Link
            to="/"
            onClick={() => setIsOpen(false)}
            className="flex items-center gap-3 p-3 rounded-lg hover:bg-sidebar-ring transition-colors mb-2"
            activeProps={{
              className:
                'flex items-center gap-3 p-3 rounded-lg bg-sidebar-primary hover:bg-sidebar-ring transition-colors mb-2',
            }}
          >
            <Home size={20} />
          ...
          <div className="flex flex-row justify-between">
            <Link
              to="/demo/start/ssr"
              onClick={() => setIsOpen(false)}
              className="flex-1 flex items-center gap-3 p-3 rounded-lg hover:bg-sidebar-ring transition-colors mb-2"
              activeProps={{
                className:
                  'flex-1 flex items-center gap-3 p-3 rounded-lg bg-sidebar-primary hover:bg-sidebar-ring transition-colors mb-2',
              }}
            >
              <StickyNote size={20} />
